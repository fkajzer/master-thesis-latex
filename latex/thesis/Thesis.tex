...
\input{sections/2_related_work/medical_imaging/main.tex}
\section{\label{sec::VirtualRealityInMedicine}Virtual Reality in Medicine}
\input{sections/2_related_work/virtual_reality_in_medicine/main.tex}
...
\input{sections/2_related_work/discussion/main.tex}
...
\input{sections/4_implementation/architecture/main.tex}
\section{\label{sec::SteamVR}SteamVR}
\input{sections/4_implementation/steam_vr/main.tex}
