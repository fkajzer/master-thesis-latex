After the thorough requirement analysis in Section \ref{sec::RequirementAnalysis} on which a concept for the software was derived in Section \ref{sec::Concept}, 
...
\input{sections/4_implementation/virutal_ot.tex}
